...
import com.example.user.healthsupervisor.Task;

import java.util.ArrayList;
import java.util.List;

public class Maintodo extends AppCompatActivity {
    private static final String TAG = Maintodo.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maintodo);
        ...
        addTaskButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(enteredTask)){
                    Toast.makeText(Maintodo.this, "You must enter a task first", Toast.LENGTH_LONG).show();
                    return;
                }
                if(enteredTask.length() < 6){
                    Toast.makeText(Maintodo.this, "Task count must be more than 6", Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    private void getAllTask(DataSnapshot dataSnapshot){
        for(DataSnapshot singleSnapshot : dataSnapshot.getChildren()){
            ...
            recyclerViewAdapter = new RecyclerViewAdapter(Maintodo.this, allTask);

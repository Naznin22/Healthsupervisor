...
public class mylayout extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent myIntent = new Intent(mylayout.this, AlarmReceiver.class);
        pendingIntent = PendingIntent.getBroadcast(mylayout.this, 0, myIntent, 0);
